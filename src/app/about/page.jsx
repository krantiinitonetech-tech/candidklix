          ...
          <div className="container">
            <header className="why-header">
              ...
              <p className="lead muted">
                Excellence in every detail, authenticity in every frame
              </p>
            </header>

            <div className="features-grid">
              {[
                ["Personal Attention", "Every client receives dedicated care and customized service tailored to their unique needs."],
                ["Reliable Delivery", "Timely delivery of beautifully edited images you can count on."],
                ["Cinematic Editing", "Soft, timeless tones with natural color grading and professional retouching."],
                ["Professional Expertise", "Years of artistic experience dedicated to capturing your most meaningful moments."]
              ].map(([title, desc]) => (
