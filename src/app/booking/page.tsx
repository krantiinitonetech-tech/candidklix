...
const ghost = {
  ...
  // const primary = { flex: 1, background: "", border: 0, padding: "12px 18px", fontWeight: 700, cursor: "pointer" } as const;
  // const ghost = { flex: 1, background: "transparent", border: "1px solid rgba(2,6,23,0.08)", padding: "12px 18px", cursor: "pointer" } as const;
  ...
  return (
      <>
        ...
        {/* <Breadcrumb items={[{ href: "/contact", label: "Book Session" }]} /> */}
           <header className="terms-hero">
        <div className="container">
          <h1 className="terms-title">Candid Klix — Quote Request</h1>
          <p className="terms-lead">
            Fill out the form and we’ll email an estimated quote and availability.
          </p>
        </div>
      </header>
    <div style={page}>
