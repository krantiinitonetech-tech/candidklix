...
function Lightbox({ files, index, onClose, onPrev, onNext }) {
  ...
  return createPortal(
    <div style={{
      ...
      <div style={{ position: "relative", maxWidth: 1200, width: "100%", margin: "0 20px" }}>
        <button onClick={onClose} style={btnStyle}>×</button>
        <button onClick={onPrev} style={{ ...arrowStyle, left: 10 }}>‹</button>
        <button onClick={onNext} style={{ ...arrowStyle, right: 10 }}>›</button>
